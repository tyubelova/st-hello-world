...
def charts():
    ...
    st.markdown("""
        ...
        Кроме того, если описанного функционала мала, streamlit совместим с такими библиотеками как Matplotlib (через st.pyplot) и Plotly (через st.plotly). 
       
        Так, например, нарисуем тепловую диаграмму суммы наших чеков, используя streamlit и Plotly:
    """)
    st.code("""
